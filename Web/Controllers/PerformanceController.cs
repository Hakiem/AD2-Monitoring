...
namespace Web.Controllers
{
    public class PerformanceController : Controller
    {
        ...
        private static List<MonitorWithStringDates> GetCachedMonitorItemsBetweenDates(string dateFrom, string dateTo)
        {
            ...
            return (
                        ...
                        select new MonitorWithStringDates
                        {
                            ...
                            Max = monitorItem.Max,
                            Avg = monitorItem.Avg,
                            From = string.Format("{0:MMM dd-yy HH:mm:ss}", monitorItem.From)
                        }
                    ).ToList();
        }
        ...
        {
            var cachedPerformanceCounterDictionary = 
                HttpRuntime.Cache.Get("CachedPerformancCounterDictionary") as SortedDictionary<string, List<TreeViewPropertiesClass>>;
